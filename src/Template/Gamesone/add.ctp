...
<div class="container">
    <?= $this->Form->create($gameone, array('type' => 'file')) ?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <table class="table table-bordered table-invers" style="width: 100%">
                <tr>
                    ...
                    <td bgcolor="#696969"><font color="white">ขั้นตอนที่ 2</font></td>
                ...
                <tbody>
                    ...
                    foreach ($arrchkrank as $chkrank):
                        ...
                        <tr>
                            ...
                            <td class="text-center"><input type="text" name="game1_nameTH<?= $chkrank ?>" style="width: 100%" id="game1nameTH<?= $chkrank ?>"></td>
                            <td class="text-center"><input type="text" name="game1_nameEN<?= $chkrank ?>" style="width: 100%" id="game1nameEN<?= $chkrank ?>"></td>
                            <td class="text-center"><input type="file" name="game1_voiceTH<?= $chkrank ?>" style="width: 100%" id="game1voiceTH<?= $chkrank ?>"></td>
                            <td class="text-center"><input type="file" name="game1_voiceEN<?= $chkrank ?>" style="width: 100%" id="game1voiceEN<?= $chkrank ?>"></td>
                            <td class="text-center"><input type="file" name="game1_image<?= $chkrank ?>" style="width: 100%" id="game1image<?= $chkrank ?>"></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
