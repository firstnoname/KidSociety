    ...
    <table class="table table-bordered table-invers" style="width: 100%">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('time_g1') ?></th>
                <th scope="col"><?= $this->Paginator->sort('time_g2') ?></th>
                <th scope="col"><?= $this->Paginator->sort('time_g3') ?></th>
                <th scope="col"><?= $this->Paginator->sort('time_g4') ?></th>
